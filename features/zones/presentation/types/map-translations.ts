export type MapTranslations = {
  ...
  zoneDetailReportTitle: string;
  zoneDetailReportSubtitleAnonymous: string;
  zoneDetailReportSubtitleAuthenticated: string;
  zoneDetailReportLoginRequired: string;
  zoneDetailReportOpen: string;
  zoneDetailReportReasonLabel: string;
  zoneDetailReportReasonPlaceholder: string;
  zoneDetailReportReasonDuplicateOrSpam: string;
  zoneDetailReportReasonFalseOrInaccurateInfo: string;
  zoneDetailReportReasonOffensiveOrHarmfulContent: string;
  zoneDetailReportReasonWrongLocation: string;
  zoneDetailReportReasonOther: string;
  zoneDetailReportDetailsLabel: string;
  zoneDetailReportDetailsPlaceholder: string;
  zoneDetailReportDetailsRequired: string;
  zoneDetailReportSubmit: string;
  zoneDetailReportSubmitting: string;
  zoneDetailReportSuccess: string;
  zoneDetailReportZoneHidden: string;
  zoneDetailReportDuplicate: string;
  zoneDetailReportErrorFallback: string;
};
