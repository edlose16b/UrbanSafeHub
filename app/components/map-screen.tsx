...
export type MapTranslations = {
  ...
  citySwitcherPlaceholder: string;
  cityCountryArgentina: string;
  cityCountryBolivia: string;
  cityCountryColombia: string;
  cityCountryEcuador: string;
  cityCountryMexico: string;
  cityCountryPeru: string;
  cityCountryVenezuela: string;
